    ...
    <div>
      {this.state.loading ? (
        <>
          ...
          <div className='my-10'>
            <Skeleton className='hidden lg:block lg:h-96 lg:w-60 lg:m-0 lg:float-left lg:mr-10' />
        ...
        <>
          ...
          {noResults ? (
            ...
            <>
              <main className="grid mt-10 lg:grid-cols-3 gap-6 md:grid-cols-2 gap-4 sm: grid-cols-1 gap-2">
                  ...
                  return (
                    <Button
                      ...
                      className={`mx-1 px-3 py-1 ${
                        currentPage === pageNumber ? 'bg-rose-950 text-white' : 'bg-gray-200'
                      }`}
                    >
                      {pageNumber}
                    </Button>
